...
def train(nloader, aloader, model, batch_size, optimizer, device,pre_model):
    with torch.set_grad_enabled(True):
        ...
        score_abnormal, score_normal, feat_select_abn, feat_select_normal,scores, X,atten= model(input)  # b*32  x 2048
